## generate the F# and the component module

The following will generate the F# code given a wit file:

```bash
cargo run fsharp --string-encoding utf8 --out-dir testing-fsharp tests/codegen/floats.wit
```
